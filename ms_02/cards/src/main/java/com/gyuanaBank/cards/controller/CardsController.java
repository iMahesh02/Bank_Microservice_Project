package com.gyuanaBank.cards.controller;

import com.gyuanaBank.cards.constants.CardsConstants;
import com.gyuanaBank.cards.dto.CardsContactInfoDto;
import com.gyuanaBank.cards.dto.CardsDto;
import com.gyuanaBank.cards.dto.ErrorResponseDto;
import com.gyuanaBank.cards.dto.ResponseDto;
...
@Tag(
        name = "REST APIs for Cards in Bank_of_Guyana",
        description = "REST APIs in Bank_of_Guyana to CREATE, READ, UPDATE and DELETE card details"
)
@RestController
...
public class CardsController {
    ...
    @Operation(
          ...
          description = "REST API to create new Card inside Bank_of_Guayna"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
